...
class mysql {
    ...
    */
    ...
    /*取得结果数据*/
    public function mysql_result_li($str,$row,$col) {
        return mysql_result($str,$row,$col);
    }
...
class DbManager{
    ...
    private $DBManager= array();
    private $mysql_server_name="192.168.18.147"; //数据库服务器名称
    ...
    public  function  get_db_conn(){
        ...
        return $this->DBManager[$this->mysql_count];
    }
    public static function  echo_info(){
        echo '111';
    }
}
